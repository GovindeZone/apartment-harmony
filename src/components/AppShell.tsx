    ...
    <nav className="flex flex-col gap-1">
      {NAV.map((item) => (
        <Link
          ...
          activeProps={{
            className:
              "bg-sidebar-primary/12 text-sidebar-primary font-semibold hover:bg-sidebar-primary/12 hover:text-sidebar-primary",
          }}
        >
  ...
  return (
    <div className="flex items-center gap-3 px-2 py-1">
      ...
      <span className="leading-tight">
        <span className="block text-sm font-semibold text-foreground">Indus Anantya Apartment</span>
...
export function AppShell({
  ...
  return (
    <div className="min-h-screen bg-background">
      <aside className="fixed inset-y-0 left-0 z-30 hidden w-64 flex-col justify-between border-r border-border bg-sidebar p-4 lg:flex">
